...
class TwitterAPICaller: BDBOAuth1SessionManager {
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "3iIQCOMQ1QNeSPVRzRMyqmHFZ", consumerSecret: "pE78CfYILPblGgR3CBcp3wF9HAc0WoDhs9glovl9qEYlnjKVmJ")
    
    // consumerKey : 5lUJuO5AUpPUCez4ewYDFrtgh
    // consumerSecret : s5ynGqXzstUZwFPxVyMDkYh197qvHOcVM3kwv1o2TKhS1avCdS
    var loginSuccess: (() -> ())?
